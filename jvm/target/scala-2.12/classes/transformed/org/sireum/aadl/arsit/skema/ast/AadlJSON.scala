package org.sireum.aadl.arsit.skema.ast {
  ...
  object JSON {
    ...
    @record class Parser(_input: String) extends _root_.org.sireum.RecordSig {
      ...
      override lazy val content: _root_.scala.Seq[scala.Tuple2[_root_.java.lang.String, _root_.scala.Any]] = _root_.scala.Seq(scala.Tuple2("type", _root_.scala.List[_root_.java.lang.String]("org", "sireum", "aadl", "arsit", "skema", "ast", "Parser")), scala.Tuple2("input", input));
